...
// // import Mountains from "../assets/images/Mountains.mp4";
...
//         {/* <video
//           src="/assets/images/Mountains.mp4" // Public URL path
//           autoPlay
//           loop
//           muted
//           playsInline
...
//         {/* Circle with video (instead of image) */}
//         <div className="w-[400px] h-[500px] sm:w-[250px] sm:h-[250px] lg:w-[300px] lg:h-[300px] rounded-full border-[8px] sm:border-[10px] lg:border-[12px] border-gray-300 overflow-hidden mb-6 lg:mb-0 lg:absolute lg:left-52 lg:top-28">
//           <video
//             src="/Mountans.mp4" // public folder path
//             autoPlay
//             loop
//             muted
//             playsInline
...
//           />
//         </div>
//         <video src="Mountains.mp4" autoPlay muted loop width="300" height="300"></video>
